...
class Nav extends Component {
  ...
  componentDidMount() {
    ...
    TweenLite.fromTo("#toBeRevealed", 1, { backgroundPosition: "-130px 0" }, { backgroundPosition: "20px 0" });
      ...
      <nav className="navbar navbar-expand-lg navbar-dark">
        <Container fluid>
          <Row>
            ...
            <Col size="md-4">
              <svg id="demo" viewBox="0 0 500 100">
                <defs>
                  <mask id="theMask">
                    <rect id="theSquare" x="-350" y="0" fill="#fff" />
                  </mask>
                </defs>
                <g id="toBeRevealed" mask="url(#theMask)">
              ...
              <ul className="nav nav-tabs">
                <li className="nav-item">
                  <Link
                    to="/userPortal"
                    className={
                      window.location.pathname === "/userPortal" ? "nav-link active" : "nav-link"
                    }
                  >
                    Home
                </Link>
                ...
                <li className="nav-item">
                  <Link
                    to="/user"
                    className={
                      window.location.pathname === "/user" || window.location.pathname === "/roomCreate" || window.location.pathname === "/userHome"
